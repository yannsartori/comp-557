...
public class A3App implements SceneGraphNode {
	...
	public static void main(String[] args){
	    ...
	    String windowTitle = "Bezier Patch Drawer Yann Sartori 260822776";
    ...
    public A3App() {
    	...
    	/** My example for the rotational surface **/
    	//patchwork = new BezierPatchWork("data/a3data/my-patch.txt");
    	/** My example for the rational surface **/
    	patchwork = new BezierPatchWork("data/a3data/sphere.txt");

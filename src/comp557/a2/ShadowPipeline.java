...
public class ShadowPipeline {
    ...
    // used to calculate vertex position w.r.t the light
	...
	public void startCameraViewPass( GLAutoDrawable drawable ) {
		...
		currentGLSLProgram.glUniformMatrix(gl, lightPID, this.light.P);
		currentGLSLProgram.glUniformMatrix(gl, lightVID, this.light.V);
	}
